// date 25.12.03 15:58 / 16:10 / 16:46
//title: Oracle db를 불러오기
package jdbc;
...
public class MemberDao {
    ...
    // Oracle 연결
    Connection          con     = null; // 물리적 떨어진 Oracle Server에 세션을 연결
    PreparedStatement   pstmt   = null; // 개발자의 작성한 Select문을 전달하고 요청
    ResultSet           rs      = null; // Oracle 내부 cursor를 추상화한 Interface

    /* *************************************************************
    - Oracle Scott 계정에서 회원정보 가져오기 구현
    ...
    > 나는 메서드를 설계할 수 있다.
    > 나는 파라미터 개수와 타입을 결정핳고 리턴타입을 선택할 수 있다.
    ************************************************************** */
